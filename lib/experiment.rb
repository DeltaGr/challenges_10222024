...
def belongs_to?(a_string, a_word)
  ...
  # SOLUTION:
  # Probtip: try to read the code backwards
  # For example: Question: We want to know, if a_word is included in a_string
  # afterwards needs a puts command with the actual phrase which should be checked
  # than check if it is running in the terminal by using "ruby lib/experiment.rb"
  # Remember: It is a different folder for different challenges
end
...
def replace(initial_string, old_letter, new_letter)
  ...
  # my_string = old_letter_to_new_letter
  #   replace_old_letter(:leet_speak) do
  #     self.gsub("casanova","a", "o")
  #     return
  #   end
  # end

  # s = "casanova".leet_speak()

  # puts s
"casanova".gsub(/[aeiau]/, {"a" => "o"})
# "cosonovo"
end
